...
test("viewer report page stays read-only while member roles can create packets", () => {
  ...
  assert.match(reportsPage, /Packet editing requires member access/);
  assert.match(reportsPage, /cannot create or edit\s+NGO packets/);
});
